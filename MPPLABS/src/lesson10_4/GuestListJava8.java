...
import static lesson10_4.PredicateWithException.unchecked;
public class GuestListJava8 {
	...
	public void printListOfExpectedFemaleGuests(List<Guest> listGuest) {
	System.out.println(listGuest.stream()
