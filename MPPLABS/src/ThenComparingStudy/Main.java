...
public class Main {
	...
	List<Account> sort = accounts.stream().sorted(Comparator.comparing((Account a)->a.getBalance()).reversed().thenComparing(a-> a.getOwnerName())).collect(Collectors.toList());
