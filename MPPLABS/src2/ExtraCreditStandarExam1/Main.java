...
public class Main {
	public static void main(String[] args) {
		...
		someSavingsAccounts[0] = new SavingsAccount(200, 0.03, "44-8123");
		someSavingsAccounts[1] = new SavingsAccount(200, 0.03, "21-9672");
		someSavingsAccounts[2] = new SavingsAccount(600, 0.04, "68-0902");
