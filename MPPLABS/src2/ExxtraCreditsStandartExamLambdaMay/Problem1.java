package ExxtraCreditsStandartExamLambdaMay;
...
public class Problem1 {
	...
	public static List<String> getAllFairfieldCustomers(List<Customer> list) {
		//implement
		return
		list.stream().filter(x-> x.getCity().equals("Fairfield")).map(Customer::getName).sorted(Comparator.comparing(String::toString).reversed()).collect(Collectors.toList());
	}
