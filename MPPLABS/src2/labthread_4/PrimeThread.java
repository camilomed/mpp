...
public class PrimeThread extends Thread {
    ...
    public void run() {
       ...
       System.out.println("Inside BEGINNING " + threadNumber1 + "-" + threadNumber2);      
        
        System.out.println("Prime: " + threadNumber1 + " & " + threadNumber2 );
        ...
        System.out.println("Inside END" + threadNumber1+ "-" + threadNumber2);      
